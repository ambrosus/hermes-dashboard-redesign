      ...
      <UiModal modalName="secureKeys">
        <div className="auth-modal-container">
          ...
          <p>
            ...
            keep private keys online, in a mail or in the cloud. There they are
            most susceptible to getting obtained by bad actors.
          </p>
          <p>
            ...
            are only safe as long as they are not in the hands of an attacker. One
            can also use offline drives that encrypt the data stored on them. This
            way you can add one more security layer for accessing your account. If
            there is no possibility to obtain a hardware wallet, the other option
            is paper wallet. A paper wallet is a piece of paper that prints the
            pair of private and public keys on it. To make it more secure, you can
            laminate it and store it in a vault.
          </p>
          <p>
